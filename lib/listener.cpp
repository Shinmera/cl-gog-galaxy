...
class Listener : 
    virtual public IAuthListener,
    virtual public IIsDlcOwnedListener,
    virtual public IChatRoomWithUserRetrieveListener,
    virtual public IChatRoomMessageSendListener,
    virtual public IChatRoomMessagesListener,
    virtual public IChatRoomMessagesRetrieveListener,
    virtual public ICloudStorageGetFileListListener,
    virtual public ICloudStorageGetFileListener,
    virtual public ICloudStoragePutFileListener,
    virtual public ICloudStorageDeleteFileListener,
    virtual public IConnectionOpenListener,
    virtual public IConnectionCloseListener,
    virtual public IConnectionDataListener,
    virtual public IPersonaDataChangedListener,
    virtual public IUserInformationRetrieveListener,
    virtual public IFriendListListener,
    virtual public IFriendInvitationSendListener,
    virtual public IFriendInvitationListRetrieveListener,
    virtual public ISentFriendInvitationListRetrieveListener,
    virtual public IFriendInvitationListener,
    virtual public IFriendInvitationRespondToListener,
    virtual public IFriendAddListener,
    virtual public IFriendDeleteListener,
    virtual public IRichPresenceChangeListener,
    virtual public IRichPresenceListener,
    virtual public IRichPresenceRetrieveListener,
    virtual public IGameJoinRequestedListener,
    virtual public IGameInvitationReceivedListener,
    virtual public ISendInvitationListener,
    virtual public IUserFindListener,
    virtual public ILobbyListListener,
    virtual public ILobbyCreatedListener,
    virtual public ILobbyEnteredListener,
    virtual public ILobbyLeftListener,
    virtual public ILobbyDataListener,
    virtual public ILobbyDataUpdateListener,
    virtual public ILobbyMemberDataUpdateListener,
    virtual public ILobbyDataRetrieveListener,
    virtual public ILobbyMemberStateListener,
    virtual public ILobbyOwnerChangeListener,
    virtual public ILobbyMessageListener,
    virtual public INetworkingListener,
    virtual public INatTypeDetectionListener,
    virtual public IUserStatsAndAchievementsRetrieveListener,
    virtual public IStatsAndAchievementsStoreListener,
    virtual public IAchievementChangeListener,
    virtual public ILeaderboardsRetrieveListener,
    virtual public ILeaderboardEntriesRetrieveListener,
    virtual public ILeaderboardScoreUpdateListener,
    virtual public ILeaderboardRetrieveListener,
    virtual public IUserTimePlayedRetrieveListener,
    virtual public IFileShareListener,
    virtual public ISharedFileDownloadListener,
    virtual public ITelemetryEventSendListener,
    virtual public IOtherSessionStartListener,
    virtual public IOperationalStateChangeListener,
    virtual public IUserDataListener,
    virtual public ISpecificUserDataListener,
    virtual public IEncryptedAppTicketListener,
    virtual public IAccessTokenListener,
    virtual public IPlayFabCreateOpenIDConnectionListener,
    virtual public IPlayFabLoginWithOpenIDConnectListener,
    virtual public IOverlayVisibilityChangeListener,
    virtual public IOverlayInitializationStateChangeListener,
    virtual public INotificationListener,
    virtual public IGogServicesConnectionStateListener {
public:
