...
class Listener : public IIsDlcOwnedListener,
...
public:
  ...
  void OnAuthFailure(FailureReason failureReason) override {
    ...
    this->listener.OnAuthFailure(this->listener.userptr, (enum gog_AuthFailureReason)reason);
  }
  ...
  void OnOperationalStateChanged(uint32_t operationalState) override {
    ...
    this->listener.OnOperationalStateChanged(this->listener.userptr, (enum gog_OperationalState)state);
  }
  ...
  void OnSpecificUserDataUpdated(GalaxyID userID) override {
    ...
    this->listener.OnSpecificUserDataUpdated(this->listener.userptr, (gog_ID)user);
  }
  ...
  void OnPersonaDataChanged(GalaxyID userID, uint32_t personaStateChange) override {
    ...
    this->listener.OnPersonaDataChanged(this->listener.userptr, (gog_ID)userID, (uint32_t)personaStateChange);
  }

  void OnUserInformationRetrieveSuccess(GalaxyID userID) override {
    if(!this->listener.OnUserInformationRetrieveSuccess) return;
    this->listener.OnUserInformationRetrieveSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnUserInformationRetrieveFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnUserInformationRetrieveFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FailureReason)failureReason);
  }
  ...
  void OnFriendInvitationSendSuccess(GalaxyID userID) override {
    ...
    this->listener.OnFriendInvitationSendSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnFriendInvitationSendFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnFriendInvitationSendFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FriendInvitationFailureReason)failureReason);
  }
  ...
  void OnFriendInvitationReceived(GalaxyID userID, uint32_t sendTime) override {
    ...
    this->listener.OnFriendInvitationReceived(this->listener.userptr, (gog_ID)userID, (uint32_t)sendTime);
  }
  ...
  void OnFriendInvitationRespondToSuccess(GalaxyID userID, bool accept) override {
    ...
    this->listener.OnFriendInvitationRespondToSuccess(this->listener.userptr, (gog_ID)userID, (bool)accept);
  }
  ...
  void OnFriendInvitationRespondToFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnFriendInvitationRespondToFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FriendInvitationRespondFailureReason)failureReason);
  }

  void OnFriendAdded(GalaxyID userID, InvitationDirection invitationDirection) override {
    if(!this->listener.OnFriendAdded) return;
    this->listener.OnFriendAdded(this->listener.userptr, (gog_ID)userID, (enum gog_InvitationDirection)invitationDirection);
  }

  void OnFriendDeleteSuccess(GalaxyID userID) override {
    if(!this->listener.OnFriendDeleteSuccess) return;
    this->listener.OnFriendDeleteSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnFriendDeleteFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnFriendDeleteFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FailureReason)failureReason);
  }
  ...
  void OnRichPresenceUpdated(GalaxyID userID) override {
    ...
    this->listener.OnRichPresenceUpdated(this->listener.userptr, (gog_ID)userID);
  }

  void OnRichPresenceRetrieveSuccess(GalaxyID userID) override {
    if(!this->listener.OnRichPresenceRetrieveSuccess) return;
    this->listener.OnRichPresenceRetrieveSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnRichPresenceRetrieveFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnRichPresenceRetrieveFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FailureReason)failureReason);
  }

  void OnGameJoinRequested(GalaxyID userID, const char* connectionString) override {
    if(!this->listener.OnGameJoinRequested) return;
    this->listener.OnGameJoinRequested(this->listener.userptr, (gog_ID)userID, (const char*)connectionString);
  }
  ...
  void OnGameInvitationReceived(GalaxyID userID, const char* connectionString) override {
    ...
    this->listener.OnGameInvitationReceived(this->listener.userptr, (gog_ID)userID, (const char*)connectionString);
  }
  ...
  void OnInvitationSendSuccess(GalaxyID userID, const char* connectionString) override {
    ...
    this->listener.OnInvitationSendSuccess(this->listener.userptr, (gog_ID)userID, (const char*)connectionString);
  }
  ...
  void OnInvitationSendFailure(GalaxyID userID, const char* connectionString, FailureReason failureReason) override {
    ...
    this->listener.OnInvitationSendFailure(this->listener.userptr, (gog_ID)userID, (const char*)connectionString, (enum gog_SendInvitationFailureReason)failureReason);
  }

  void OnUserFindSuccess(const char* userSpecifier, GalaxyID userID) override {
    if(!this->listener.OnUserFindSuccess) return;
    this->listener.OnUserFindSuccess(this->listener.userptr, (const char*)userSpecifier, (gog_ID)userID);
  }
  ...
  void OnChatRoomWithUserRetrieveSuccess(GalaxyID userID, ChatRoomID chatRoomID) override {
    ...
    this->listener.OnChatRoomWithUserRetrieveSuccess(this->listener.userptr, (gog_ID)userID, (gog_ChatRoomID)chatRoomID);
  }
  ...
  void OnChatRoomWithUserRetrieveFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnChatRoomWithUserRetrieveFailure(this->listener.userptr, (gog_ID)userID, (enum gog_ChatUserRetrieveFailureReason)failureReason);
  }
  ...
  void OnLobbyCreated(const GalaxyID& lobbyID, LobbyCreateResult result) override {
    ...
    this->listener.OnLobbyCreated(this->listener.userptr, (gog_ID)lobbyID, (enum gog_LobbyCreateResult)result);
  }

  void OnLobbyEntered(const GalaxyID& lobbyID, LobbyEnterResult result) override {
    if(!this->listener.OnLobbyEntered) return;
    this->listener.OnLobbyEntered(this->listener.userptr, (gog_ID)lobbyID, (enum gog_LobbyEnterResult)result);
  }

  void OnLobbyLeft(const GalaxyID& lobbyID, LobbyLeaveReason leaveReason) override {
    if(!this->listener.OnLobbyLeft) return;
    this->listener.OnLobbyLeft(this->listener.userptr, (gog_ID)lobbyID, (enum gog_LobbyLeaveReason)leaveReason);
  }
  ...
  void OnLobbyDataUpdated(const GalaxyID& lobbyID, const GalaxyID& memberID) override {
    ...
    this->listener.OnLobbyDataUpdated(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)memberID);
  }

  void OnLobbyDataUpdateSuccess(const GalaxyID& lobbyID) override {
    if(!this->listener.OnLobbyDataUpdateSuccess) return;
    this->listener.OnLobbyDataUpdateSuccess(this->listener.userptr, (gog_ID)lobbyID);
  }
  ...
  void OnLobbyDataUpdateFailure(const GalaxyID& lobbyID, FailureReason failureReason) override {
    ...
    this->listener.OnLobbyDataUpdateFailure(this->listener.userptr, (gog_ID)lobbyID, (enum gog_LobbyDataUpdateFailureReason)failureReason);
  }
  ...
  void OnLobbyMemberDataUpdateSuccess(const GalaxyID& lobbyID, const GalaxyID& memberID) override {
    ...
    this->listener.OnLobbyMemberDataUpdateSuccess(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)memberID);
  }
  ...
  void OnLobbyMemberDataUpdateFailure(const GalaxyID& lobbyID, const GalaxyID& memberID, FailureReason failureReason) override {
    ...
    this->listener.OnLobbyMemberDataUpdateFailure(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)memberID, (enum gog_LobbyDataUpdateFailureReason)failureReason);
  }
  ...
  void OnLobbyDataRetrieveFailure(const GalaxyID& lobbyID, FailureReason failureReason) override {
    ...
    this->listener.OnLobbyDataRetrieveFailure(this->listener.userptr, (gog_ID)lobbyID, (enum gog_LobbyDataRetrieveFailureReason)failureReason);
  }
  ...
  void OnLobbyMemberStateChanged(const GalaxyID& lobbyID, const GalaxyID& memberID, LobbyMemberStateChange memberStateChange) override {
    ...
    this->listener.OnLobbyMemberStateChanged(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)memberID, (enum gog_LobbyMemberStateChange)memberStateChange);
  }
  ...
  void OnLobbyOwnerChanged(const GalaxyID& lobbyID, const GalaxyID& newOwnerID) override {
    ...
    this->listener.OnLobbyOwnerChanged(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)newOwnerID);
  }
  ...
  void OnLobbyMessageReceived(const GalaxyID& lobbyID, const GalaxyID& senderID, uint32_t messageID, uint32_t messageLength) override {
    ...
    this->listener.OnLobbyMessageReceived(this->listener.userptr, (gog_ID)lobbyID, (gog_ID)senderID, (uint32_t)messageID, (uint32_t)messageLength);
  }
  ...
  void OnUserStatsAndAchievementsRetrieveSuccess(GalaxyID userID) override {
    ...
    this->listener.OnUserStatsAndAchievementsRetrieveSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnUserStatsAndAchievementsRetrieveFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnUserStatsAndAchievementsRetrieveFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FailureReason)failureReason);
  }
  ...
  void OnUserTimePlayedRetrieveSuccess(GalaxyID userID) override {
    ...
    this->listener.OnUserTimePlayedRetrieveSuccess(this->listener.userptr, (gog_ID)userID);
  }
  ...
  void OnUserTimePlayedRetrieveFailure(GalaxyID userID, FailureReason failureReason) override {
    ...
    this->listener.OnUserTimePlayedRetrieveFailure(this->listener.userptr, (gog_ID)userID, (enum gog_FailureReason)failureReason);
  }
